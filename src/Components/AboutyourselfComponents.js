...
export default class AboutYourSelf extends React.Component {
    ...
    render() {
        return (<div className="demo1">
            ...
            <blockquote className="blockquote" style={{marginTop:'3%'}}>
  <h1>About Ourself :-</h1><br/>
    <p> We are into the Business of Customer Statisfaction and Continuously providing a Quality product to our Customers.
